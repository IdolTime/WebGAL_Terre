...
; ����
!define NAME "IdolTime_Editor"
!define VERSION "4.4.13" ; �汾�ű���
!define PRODUCT_VERSION "${VERSION}.0"
!define COPYRIGHT "IdolTime - https://github.com/IdolTime" ; ��Ȩ��Ϣ
...
OutFile "./bundle/IdolTime_Editor_Setup.exe" ; ��װ�����·��
...
Section -Install
    ...
    ; �ó����Թ���Ա��������
    WriteRegStr HKCU "SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers" "$INSTDIR\IdolTime_Editor.exe" "RUNASADMIN"
SectionEnd
